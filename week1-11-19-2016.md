...
When receiving the responses, it will identify the response based on the code, such as 200,505 or 404. If the response objects can be cached, store them locally. Finally, browser will render the responses and show the pages or imgaes.
