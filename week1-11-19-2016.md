...
To make all the process in details, it might take much time to do. There are lots things happening at the same time. For `HTTPS`, the situation could be more complex, key distribution, certificates identify, signature, etc.
